...
var render = function () {
  ...
  var l0 =
    _vm.current === 0
      ...
      : null
  var g0 = _vm.current === 0 ? _vm.pickupList.length : null
  var l1 =
            ...
            switch (_context2.prev = _context2.next) {
              ...
              case 4:
                ...
                if (res.result.data && res.result.data.length > 0) {
                  _this2.storeName = res.result.data[0].store_name || '七香嫂包子铺';
                }
                _context2.next = 11;
                break;
              case 8:
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 9:
                ...
                _this3.pickupList = allOrders.filter(function (o) {
                  return o.type === 'takein';
                });
                _this3.takeoutList = allOrders.filter(function (o) {
                  return o.type === 'takeout';
                });
                _this3.couponList = []; // 优惠券订单逻辑如果有可在此处理
                _context3.next = 20;
                break;
              case 16:
                _context3.prev = 16;
