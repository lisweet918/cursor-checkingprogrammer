...
try {
  components = {
    ...
    uSwiper: function () {
      return __webpack_require__.e(/*! import() | uni_modules/vk-uview-ui/components/u-swiper/u-swiper */ "uni_modules/vk-uview-ui/components/u-swiper/u-swiper").then(__webpack_require__.bind(null, /*! @/uni_modules/vk-uview-ui/components/u-swiper/u-swiper.vue */ 245))
    },
    uImage: function () {
...
var render = function () {
  ...
  var m0 = _vm.glassPressed("user")
  var m1 = _vm.glassPressed("dine")
  var m2 = _vm.glassPressed("takeout")
...
var _glassMotion = _interopRequireDefault(__webpack_require__(/*! @/common/glass-motion.js */ 87));
...
var _default = {
  ...
  computed: _objectSpread(_objectSpread({}, (0, _vuex.mapState)(['tableInfo'])), {}, {
    displayTableNumber: function displayTableNumber() {
  ...
  methods: _objectSpread(_objectSpread({
    ...
    openTablePopup: function openTablePopup() {
    ...
    handlePointSingle: function handlePointSingle(type) {
      var activeTableNumber = this.tableInfo && this.tableInfo.tableNumber || this.currentTableNumber || '';
      var diningCount = this.tableInfo && this.tableInfo.diningCount || 0;
