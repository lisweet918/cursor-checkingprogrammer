...
var _default = {
  ...
  methods: {
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 3:
                ...
                now = Date.now();
                _context4.next = 8;
                return db.collection('user_coupons').where("user_id == \"".concat(_this4.userinfo.openid, "\" && status == 0 && expire_time > ").concat(now)).count();
              case 8:
                res = _context4.sent;
                _this4.couponCount = res.result.total || 0;
                _context4.next = 15;
                break;
              case 12:
                _context4.prev = 12;
    ...
    handleMyOrder: function handleMyOrder(status) {
      uni.navigateTo({
        url: "/subpackageMy/myOrder/my-order?status=".concat(status)
      });
    }
  }
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _my_vue_vue_type_template_id_0be17cc6_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./my.vue?vue&type=template&id=0be17cc6&scoped=true& */ 99);
...
/* harmony import */ var _my_vue_vue_type_style_index_0_id_0be17cc6_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./my.vue?vue&type=style&index=0&id=0be17cc6&lang=scss&scoped=true& */ 103);
