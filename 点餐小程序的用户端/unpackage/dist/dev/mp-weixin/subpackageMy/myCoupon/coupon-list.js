...
var _couponList = _interopRequireDefault(__webpack_require__(/*! ./subpackageMy/myCoupon/coupon-list.vue */ 218));
// @ts-ignore
...
/* harmony import */ var _coupon_list_vue_vue_type_template_id_b248c472_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./coupon-list.vue?vue&type=template&id=b248c472&scoped=true& */ 219);
/* harmony import */ var _coupon_list_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./coupon-list.vue?vue&type=script&lang=js& */ 221);
...
/* harmony import */ var _coupon_list_vue_vue_type_style_index_0_id_b248c472_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./coupon-list.vue?vue&type=style&index=0&id=b248c472&lang=scss&scoped=true& */ 223);
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 6:
                ...
                _context.prev = 7;
                _context.next = 10;
                return db.collection('user_coupons').where("user_id == \"".concat(userInfo.openid, "\"")).orderBy('create_time', 'desc').get();
              case 10:
                res = _context.sent;
                all = res.result.data || [];
                now = Date.now();
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 5:
                ...
                _context2.prev = 6;
                _context2.next = 9;
                return db.collection('user_coupons').where("user_id == \"".concat(userInfo.openid, "\" && source == \"newbie\"")).count();
              case 9:
